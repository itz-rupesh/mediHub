            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse text-center" id="collapsenavbar">
                    <ul class="navbar-nav ml-auto line-height ">
                        ...
                        <div class="helpbtn">
                            <a href="../user_Profile/user_profile.php" target=""> <button id="btnID1" onmousedown="changebtn('btnID1')" onmouseup="leavbtn('btnID1')"><i class="fas fa-user-circle fa-lg"></i>&nbsp;&nbsp;<?php echo $_SESSION['first_name']." ".$_SESSION['last_name'] ?></button></a>
                        </div>
                    </ul>
                </div>
            </div>
        ...
        <div class="container-fluid">
                        ...
                        <table class="table table-responsive xl-auto md-auto lg-auto" id="dev-table">
                            <thead>
                                <tr class="table-row">
                                    ...
                                    <th class="col-2">Clinic Location</th>
                                    <th class="col-2">Date </th>
                                    <th class="col-3">Slot Time</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
            ...
            <div class="button_row">
                <div class="appointment_btn">
                    <a href="../appointment/appointment.php" target=""><button id="btnID2" onmousedown="changebtn('btnID2')" onmouseup="leavbtn('btnID2')">MAKE AN APPOINTMENT</button></a>
                </div>
                <div class="logout_btn">
                    <a href="../login_signup/logout.php" target=""><button id="btnID3" onmousedown="changebtn('btnID3')" onmouseup="leavbtn('btnID3')">LOGOUT</button></a>
                </div>
            </div>
        </div>
        <footer>
